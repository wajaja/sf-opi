 ...
 *     repositoryClass="OP\UserBundle\Repository\InvitationGroupRepository",
 * indexes={
 *          @MongoDB\index(keys={"sendingDate"="desc"}),
 *          @MongoDB\index(keys={"sender.$id"="asc"}),
 *          @MongoDB\index(keys={"group.$id"="desc"}),
...
class InvitationGroup
{
     ...
     * @var string $receiver
     *
     * @MongoDB\ReferenceOne(targetDocument="OP\UserBundle\Document\Group")
     */
    protected $receiver;
