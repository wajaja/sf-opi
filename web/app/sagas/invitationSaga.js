...
export default function* invitationSaga() {
	...
	yield takeLatest("INVITATION::CONFIRM", callConfirm);
	yield takeLatest("INVITATION::DELETE", callDelete);
	yield takeLatest("INVITATION::FOLLOW", callFollow);
	yield takeLatest("INVITATION::REQUEST", callRequest);
	yield takeLatest("INVITATION::UNFOLLOW", callUnFollow);
}