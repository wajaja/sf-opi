...
export const Flash = props => {
    const { unreadCount, timeAgo, url, isRead } = props.data;
...
export const PostCreated = props => {
    const { author, timeAgo, url, isRead } = props.data
...
export const PostAllieCreated = props => {
    ...
    const { nbAllies, author, lastUser, timeAgo, url, isRead }  = props.data,
        nbOthers          = nbAllies -1
...
export const OpinionCreated = props => {
    ...
    const { author, sidename, opinionTitle, timeAgo, url, isRead } = props.data
...
export const OpinionAllieCreated = props => {
    ...
    const { author, opinionTitle, postOrder, timeAgo, url, isRead } = props.data
...
export const SideToAuthor = props => {
    ...
    const { lastSider, sidename, unreadCount, timeAgo, url, isRead } = props.data
...
export const SideToUser = props => {
    ...
    const { lastSider, sidename, author, title, postOrder, timeAgo, url, isRead } = props.data
...
export const SideCommentToAuthor = props => {
    ...
    const { lastUser, postOrder, author, title, timeAgo, url, isRead }   = props.data
...
export const SideCommentToUser = props => {
    ...
    const { lastSider, author, lastUser, opinionTitle, 
        postOrder, unreadCount, timeAgo, url, isRead }   = props.data
...
export const CommentUserPostToAuthor = props => {
    ...
    const { author, lastUser, unreadCount, timeAgo, url, isRead }   = props.data
...
export const LikeUserToAuthor = props => {
    ...
    const { author, lastUser, unreadCount, postType, timeAgo, url, isRead }   = props.data,
            others                                   = unreadCount - 1
    const { handleNotifClick } = props;
    return(
        <div className="note-content" >
...
export const LikeUserPost = props => {
    ...
    const { author, lastUser, unreadCount, postType, timeAgo, isRead }   = props.data,
            others                                   = unreadCount - 1
    const { handleNotifClick } = props;
    return(
        <div className="note-content" >
